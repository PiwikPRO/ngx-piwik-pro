...
```
Page view on initial path entry (full page load/reload) still will be tracked, only the subsequent ones will be excluded.

This setting should be turned **ON**, it can be found in:
